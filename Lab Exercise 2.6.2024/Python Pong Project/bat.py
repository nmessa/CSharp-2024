...
class Bat:
    #### constructor
    def __init__(self, table, width=15, height=50, x_posn=50,
    ...
    #### methods
    def detect_collision(self, ball, sides_sweet_spot=True,
        ...
        if((bottom_b > top) and (top_b < bottom) and (right_b > left)
           and (left_b < right)):
            collision = True
        if(collision):
            if((top_b > top-r) and (bottom_b < bottom+r) and (right_b > right)
               and (left_b <= right)):
            ...
            if((sides_sweet_spot == True) and (collision_direction == "W"
                or collision_direction == "E")):
            ...
            if((topnbottom_sweet_spot == True) and (collision_direction == "N"
                or collision_direction == "S")):
                # find out how far from the centre of the bat the collision was
